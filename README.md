Live site link https://perfect-pointes-d5136a797ac1.herokuapp.com/
...
Custom button: Beige #B49C73
Shiny button effect: rgba(255, 255, 255, 0.8), rgba(255, 255, 255, 0)
...
US4 : Confirm registration via email
...
US8 : View shopping bag total
As a site user I can easily view the total of my purchases at any time to monitor my spending.
US9 : Easily understand the purpose of the website and how to navigate it
...
US10 : View pointe shoes by category
...
US12 : Handle 404 and 500 errors
As a site user I can return to continue shopping after http 404 or 500 response so that I feel I am still working within the website and can navigate easily

Sorting and Searching
US13 : Sort list of available pointe shoes
...
US14 : Search for a pointe shoe by title or feature
...
US17 : View notifications of user interactions
...
US18 : Finalise my order in the checkout page
...
US19 : Implement a secure payment process.
As a site user I can enter my payment details so that my payment is secure.
US20 : View an order confirmation after checkout and repurchase product
...
Footer with Mailchimp signup, links to static pages and social media.
...
Elephant SQL https://api.elephantsql.com/ - SQL database service used to store models and data.
...
Codeanywhere https://app.codeanywhere.com/ IDE used
Django mail: https://pypi.org/project/django-simple-mail/  sending the personalised/automated emails
...
Sign in or sign up to an ElephantSQL account. (Sign up at https://www.elephantsql.com/)
...
Heroku
Sign in to Heroku at https://heroku.com, or create an account if necessary.
...
Here's how to connect your Heroku app to your GitHub repository:
...
Enter the name of your GitHub repository. For example, the repository used for this project is located at https://github.com/estii20/perfect_pointes/tree/main. Click "Connect" to link up the Heroku app with the GitHub repository code.
...
Amazon Web Services (AWS) S3 for storing static files and images:
Log in to AWS:
...
https://www.online-image-editor.com/ image editor
Favicon generated at https://favicon.io/
Logo generated at Looka https://looka.com/editor/165286831

Image Compressor https://www.iloveimg.com/compress-image 
Content
Media
Project images from Unsplash.com 
...
Useful link in the footer Pointe Shoe Size Chart
https://grishkoshop.com/Page/en-US/26/pointessizechart 

https://youtu.be/NGfaWRMsS1o YouTube for Grishko 2007 shoe

Fitting professional Bloch pointe shoes New York Ballet Company
https://youtu.be/wr1UPWesLFU 
...
Online Footwear Shop tutorial to help with the product models requirements https://www.youtube.com/watch?v=NOlqN9csZao Online Footwear Shop

Bootstrap documentation for layout, card and containers https://getbootstrap.com/docs/5.0/getting-started/introduction/ 

How to make a shiny button effect
https://dev.to/designyff/button-with-shine-animation-step-by-step-guide-15l5#:~:text=For%20CSS%2C%20first%20we'll,and%20set%20position%20to%20relative.&text=Now%20we'll%20style%20the%20before%20pseudo%20element. 

How to make gold text
